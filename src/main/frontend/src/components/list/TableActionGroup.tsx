...
export const tableActionButtonClassName =
  "h-7 rounded-full border border-transparent px-2.5 text-xs font-medium text-muted-foreground shadow-none hover:bg-surface-2 hover:text-foreground focus-visible:bg-surface-2 focus-visible:text-foreground"
