...
export function QuickCapture({ compact }: QuickCaptureProps) {
  ...
  if (compact) {
    return (
      <div className="flex h-9 w-[360px] shrink-0 items-center gap-1.5 rounded-md border border-amber-500/20 bg-amber-500/5 px-2 transition-colors focus-within:border-amber-500/40 focus-within:bg-amber-500/[0.08]">
